...
class UnidadeController extends Controller
{
     ...
     */
    public function actionView($unidade)
    {
        return $this->render('view', [
            'model' => $this->findModel($unidade),
        ]);
    }
    ...
    public function actionCreate()
    {
        ...
        if ($this->request->isPost) {
            if ($model->load($this->request->post()) && $model->save()) {
                return $this->redirect(['view', 'unidade' => $model->unidade]);
            }
        } else {
     ...
     * @throws NotFoundHttpException if the model cannot be found
     */
    public function actionUpdate($unidade)
    {
        $model = $this->findModel($unidade);
     ...
     * @throws NotFoundHttpException if the model cannot be found
     */
    public function actionDelete($unidade)
    {
        $this->findModel($unidade)->delete();
     ...
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($unidade)
    {
        if (($model = UnidadeModel::findOne(['unidade' => $unidade])) !== null) {
            return $model;
        }
